...
export default function TrabajaConNosotrosPage() {
  ...
  // Helper para formatear y validar el RUT Chileno (Formatos: 12.345.678-K o 12345678K)
  const formatearRut = (valor: string) => {
    // Limpia caracteres que no sean números o 'k'/'K'
    ...
    // Aplica formato con puntos y guion
  ...
  // Manejo de la selección del archivo CV (Validación PDF/DOCX máx 5MB)
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // 2. Validar RUT (Formato básico de longitud con DV)
    const rutLimpio = rut.replace(/\./g, '');
    const regexRut = /^[0-[#kK0-9]{8,9}$/;
    ...
    // 4. Validar Selección de Especialidad
    if (!especialidad) {
      setError('Debes seleccionar una especialidad técnica.');
      return;
    }
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-gray-900 text-white rounded-t-2xl p-8 shadow-md">
          ...
          <p className="text-gray-300 mt-2 text-sm">
            Únete a nuestro equipo de trabajo en obra. Completa el siguiente formulario para ingresar tus antecedentes a nuestra base de postulación.
          </p>
        </div>

        {/* Contenedor del Formulario (Gama de grises 150 a 300) */}
        <div className="bg-gray-200 border-x border-b border-gray-300 rounded-b-2xl p-8 shadow-lg">
          ...
          {enviado ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-100 border border-gray-400 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-700 transition-all text-sm"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-14 pr-4 py-3 bg-gray-100 border border-gray-400 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-700 transition-all text-sm"
                    />
                  </div>
                </div>
              </div>

              {/* Selección de Especialidad Técnica */}
              <div>
                <label className="block text-xs font-bold text-gray-800 uppercase tracking-wider mb-2">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-gray-100 border border-gray-400 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-700 transition-all text-sm"
                >
              ...
              <div>
                <label className="block text-xs font-bold text-gray-800 uppercase tracking-wider mb-2">
                  Currículum Vitae (PDF / DOCX máx. 5MB) *
                </label>
                    ...
                    {archivoCV ? (
                      ...
                      <>
                        <p className="text-sm font-semibold text-gray-800">
                          Haz clic para adjuntar o arrastra tu archivo aquí
                        </p>
                        <p className="text-xs text-gray-500">
                          Formatos admitidos: .pdf, .docx (Máximo 5MB)
                        </p>
                      </>
                    )}
                  </div>
